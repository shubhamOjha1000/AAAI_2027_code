"""SmolVLM / SmolVLM2 adapter (Idefics3 family: 256M, 500M, 2.2B, SmolVLM2-2.2B)."""
import time
...
class SmolVLMRunner(BaseVLMRunner):
    """All SmolVLM/SmolVLM2 checkpoints share the Idefics3 processor + chat-template API."""
    name = "smolvlm"
